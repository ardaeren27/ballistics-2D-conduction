...
% PARAMETERS  One-stop config for barrel geometry & material properties.
% Usage examples:
%   p = parameters();                                   % defaults: 30HN2MFA, no Cr
%   p = parameters('steel','38HMJ','tCr_um',150);       % 150 µm chromium
%   p = parameters('steel','DUPLEX','tCr_m',2e-4);      % 0.2 mm chromium
